...
**Entando** is the leading micro frontend platform for building enterprise web applications on Kubernetes. On Entando, you can use custom blueprints to create micro frontends and microservices and assemble them into a Kubernetes-native application. We provide a modern development stack, taking best practices and leading edge tools and integrating them onto one open source platform, empowering you to rapidly create innovative user experiences. 
